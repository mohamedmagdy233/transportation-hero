...
@section('title')
    {{($setting->name_en) ?? ''}} | الرحلات الجديدة
@endsection
@section('page_name') الرحلات الجديدة   @endsection
@section('content')
    ...
    <div class="row">
        ...
        <div class="modal fade" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">بيانات الرحلة</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('trip.new')}}', columns);
        // Delete Using Ajax
        deleteScript('{{route('trip_delete')}}');
        // Add Using Ajax
        // showAddModal('{{route('city.create')}}');
        // addScript();
        // Add Using Ajax
        showEditModal('{{route('show.new',':id')}}');
        // editScript();
    </script>
@endsection
